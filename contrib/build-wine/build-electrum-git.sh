...
pushd $WINEPREFIX/drive_c/electrum-qtum
...
for i in ./locale/*; do
    dir=$WINEPREFIX/drive_c/electrum-qtum/electrum/$i/LC_MESSAGES
    mkdir -p $dir
...
cd dist
mv electrum-qtum-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
