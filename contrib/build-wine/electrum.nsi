...
;Variables
  ...
  !define PRODUCT_NAME "Electrum for Qtum"
  !define PRODUCT_WEB_SITE "https://github.com/y-chan/electrum-qtum"
...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-qtum-setup.exe"
...
;Interface Settings
  ...
  !define MUI_ICON "c:\electrum-qtum\electrum\gui\icons\electrum.ico"
...
Section
  ...
  File /r "dist\electrum-qtum\*.*"
  File "c:\electrum-qtum\electrum\gui\icons\electrum.ico"
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-qtum-${PRODUCT_VERSION}.exe" ""
  ...
  WriteRegStr HKCU "Software\Classes\qtum\shell\open\command" "" "$\"$INSTDIR\electrum-qtum-${PRODUCT_VERSION}.exe$\" $\"%1$\""
